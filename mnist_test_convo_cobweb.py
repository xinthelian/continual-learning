...
def cobweb_training(imgs, labels):
	"""
...
if __name__ == '__main__':
	...
	tree, preds_tr = cobweb_training(imgs_tr, labels_tr)

	print("==== Performance for the training set ====")
	print("Predicted:")
	print([label for label in preds_tr])
	print("Actual:")
	...
	print(errors_tr)
	print("Accuracy:")
	print(1 - sum(errors_tr) / len(labels_tr))

	print("\n==== Performance for the test set ====")
	preds_te = cobweb_testing(tree, imgs_te, labels_te)
	print("Predicted:")
	print([label for label in preds_te])
	print("Actual:")
	print([label for label in labels_te])
	print("Error:")
	errors_te = [int(preds_te[i] != v) for i, v in enumerate(labels_te)]
	print(errors_te)
	print("Accuracy:")
	print(1 - sum(errors_te) / len(labels_te))


	plt.plot(np.mean(errors_tr, 0))
	plt.plot(np.mean(errors_te, 0))
	plt.show()
