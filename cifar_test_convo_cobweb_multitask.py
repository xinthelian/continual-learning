...
def data_packaging(dataset):
	# dataset: continual-learning.data.manipulate.SubDataset
	# How the SubDataset object be like:
	# -----------
    ...
    # print(dataset)
    # print(type(dataset))
    # print(len(dataset))  # nbr of contexts
...
if __name__ == '__main__':
	...
	for i in range(n_contexts):
		...
		# print(len(datasets_tr))  # number of contexts
		# print(len(datasets_te))  # number of contexts
